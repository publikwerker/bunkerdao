        ...
        return (
            <section className="faqs">
                ...
                <div className="faqs-body">
                    ...
                    <h3 className="roadmap-subtitle">How do I obtain a Membership Card (DAObnb NFT)?</h3>
                    <p>The NFT will initially entitle the holder to online membership benefits, including:
                    </p>
                    <ul>
                        <li>The DAObnb Membership Cards will be available for purchase on this site on 02/01/2022 to individuals eligible for the Community Sale. At that time, 3,636 Leisure Membership Cards and 919 Global Membership Cards will be available</li>
                        <li>Leisure Membership Cards will cost 0.18 ETH and Global Membership cards will cost 0.72 ETH</li>
                        <li>The remaining DAObnb Membership Cards will be available for purchase on this site on 02/02/2022 to the public</li>
                    </ul>
                    ...
                    <h3 className="roadmap-subtitle">Will DAObnb retain any of the Membership Cards?</h3>
                    <p>Yes. DAObnb will retain 10% of the supply of each Membership Card type for marketing, partnerships, growth, and strategic purposes, with all benefits accruing to the DAO and Community members.
                    </p>
                    ...
                    <h3 className="roadmap-subtitle">What governance rights will DAObnb Membership Cardholders have?</h3>
                    <p>The proposal, approval, and execution of non-financial DAObnb matters, including, but not limited to…
                    </p>
                    <ul>
                        <li>Approval of DAObnb functional operating committees</li>
                        <li>Property selection process and approval, as proposed by the relevant operating committee</li>
                        <li>Design, and overall vision of DAObnb</li>
                        <li>Marketing, partnerships and sales</li>
                    </ul>
                   
                    <h3 className="roadmap-subtitle">What if the DAObnb memberships are sold out?</h3>
