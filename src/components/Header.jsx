      ...
      return (
          <header className="header">
            <div className="header-row">
              <nav>
                <a href="/">
                  <span className='logo'>STR DAO</span>
                </a>
            ...
            <div className="header-row">
              <p><strong>Short Term Rental DAO</strong> is reimagining community-managed short-term rental properties. Thousands of members have come together to crowdfund vacation rentals. There are two types of memberships for sale. The Silver Card and the Black Card, both with their own unique perks. 
              </p>
            </div>
